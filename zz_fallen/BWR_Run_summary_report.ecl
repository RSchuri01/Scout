/*
Script used for testing the summary report service
*/
...
//export options
in_input_pop_report := true;
in_score_report := false;
in_reasoncode_report :=false;
in_attribute_report := false;
in_Report_type := 'day';  //day, month
in_bin_type := 1;
requestor := 'fallen';
...
results := scout.services.summary_report_service(in_rec, report_options, true, false); //testing
// results := scout.services.summary_report_service(in_rec, report_options); //production
